...
// RESİMLERİ YENİ SENARYOYA GÖRE EŞLEŞTİRDİM:
const TAB_IMAGES = [
  "/images/macro-fiber.jpg",         // 1. Sekme: Tekstil (Havlu Lifleri) - "Neden çürüyor?"
  "/images/polymer-stress-test.png", // 2. Sekme: Yeşil Isı Haritası - "Enerji/Kireç Tıkanıklığı"
  "/images/xray-slipper.jpg"         // 3. Sekme: Terlik Röntgeni - "Kalite Algısı"
];
          ...
          <div className="flex flex-wrap items-center gap-6 md:gap-8 mb-12 border-b border-[#2A3241]">
            {t.tabs.map((tabName, index) => (
              <button
                ...
                className={`relative pb-4 text-[10px] md:text-xs font-mono tracking-widest transition-colors outline-none uppercase ${
                  activeTab === index 
