...
export default function Hero() {
    // Dil Durumu (Varsayılan: EN)
    const [lang, setLang] = useState<"EN" | "DE" | "TR">("EN");

    // Basit Çeviri Sözlüğü (Sadece efekt için, tüm siteyi çevirmek için ayrı yapı gerekir)
    const dict = {
    ...
    return (
        <section className="h-screen w-full flex flex-col justify-center items-center relative border-b border-[#2A3241] overflow-hidden bg-[#0B0E14]">
            ...
            <motion.div
                // Key değişince animasyon tekrar çalışır (Dil değiştiğinde efekt verir)
                key={lang}
